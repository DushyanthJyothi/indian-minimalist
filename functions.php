<?php
/**
 * indian_minimalist functions and definitions
 *
...
if ( ! function_exists( 'indian_minimalist_setup' ) ) :
/**
 ...
 */
function indian_minimalist_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on indian_minimalist, use a find and replace
	 * to change 'indian_minimalist' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'indian_minimalist', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary'   => __( 'Primary Menu', 'indian_minimalist' ),
		'social'    => __( 'Social Links Menu', 'indian_minimalist' ),
	) );
...
endif; // indian_minimalist_setup
add_action( 'after_setup_theme', 'indian_minimalist_setup' );
 ...
 */
function indian_minimalist_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Header Widget Column 1', 'indian_minimalist' ),
		'id'            => 'sidebar-1',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => __( 'Header Widget Column 2', 'indian_minimalist' ),
		'id'            => 'sidebar-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Header Widget Column 3', 'indian_minimalist' ),
		'id'            => 'sidebar-3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
...
add_action( 'widgets_init', 'indian_minimalist_widgets_init' );
...
function indian_minimalist_scripts() {
	...
	wp_enqueue_script( 'indian_minimalist-menus', get_template_directory_uri() . '/js/menus.js', array( 'jquery' ), '20120206', true );

	wp_enqueue_script( 'indian_minimalist-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );

	/*wp_enqueue_script( 'indian_minimalist-cookie-control', get_template_directory_uri() . '/js/cookieControl-6.2.min.js', array(), '20130115', true );*/
 ...
 */
function indian_minimalist_google_fonts() {
 ...
 * @return string
 */
function indian_minimalist_mce_css( $mce_css ) {
...
add_filter( 'mce_css', 'indian_minimalist_mce_css' );
...
if ( ! function_exists( 'indian_minimalist_the_attached_image' ) ) :
/**
 * Print the attached image with a link to the next attached image.
 *
 * @since Twenty Fourteen 1.0
 */
function indian_minimalist_the_attached_image() {
	$post                = get_post();
	/**
	 * Filter the default indian_minimalist attachment size.
	 *
	 * @since Twenty Fourteen 1.0
	 *
	 ...
	 * }
	 */
	$attachment_size     = apply_filters( 'indian_minimalist_attachment_size', array( 750, 750 ) );
